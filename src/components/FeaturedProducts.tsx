...
import dokra from "@/assets/dokra.webp";
  ...
  return (
    ...
    >
      ...
      <div className="absolute inset-0 opacity-5">
        <div
          className="absolute top-20 left-20 w-64 h-64 bg-accent rounded-full animate-float"
          style={{ animationDelay: "0s" }}
        ></div>
        <div
          className="absolute bottom-20 right-20 w-32 h-32 bg-primary rounded-full animate-float"
      ...
      <div className="container mx-auto px-4 relative">
        ...
        >
          <h2 className="text-4xl md:text-5xl font-playfair font-bold text-foreground">
            Featured{" "}
            <span className="text-transparent bg-gradient-cultural bg-clip-text animate-glow">
              Artworks
            </span>
          </h2>
          <p className="text-xl text-muted-foreground font-inter max-w-2xl mx-auto">
            Discover handpicked masterpieces from India's most talented artisans, each
            with its own authentic story preserved through AI.
          </p>
        </div>
          ...
          {products.map((product, index) => (
            ...
            >
              <div className="relative overflow-hidden">
                ...
                >
                  <Button
                    className={`bg-gradient-cultural text-cultural-red-foreground hover:opacity-90 transform transition-all duration-300 ${
              ...
              <CardContent className="p-5 space-y-3">
                ...
                <div className="space-y-2">
                  ...
                  <p className="text-sm font-inter text-muted-foreground">By {product.artist}</p>
                </div>

                {/* Pricing */}
                <div className="flex items-center space-x-2">
                  <span className="text-xl font-playfair font-bold text-foreground">{product.price}</span>
        ...
        >
          <Button
            variant="outline"
            size="lg"
            className="border-2 border-primary text-primary hover:bg-primary hover:text-primary-foreground font-inter font-semibold transform hover:scale-105 transition-all duration-300 relative overflow-hidden group"
          >
